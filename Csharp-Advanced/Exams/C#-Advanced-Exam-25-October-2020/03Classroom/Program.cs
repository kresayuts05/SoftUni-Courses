namespace ClassroomProject
{
    ...
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Student first = new Student("Dean", "Winchester", "Music");
            Student second = new Student("Sam", "Winchester", "Music");
            Student third = new Student("Castiel", "angel", "music");
            Student forth = new Student("Bobi", "Gergiov", "geograf");
            Student fifth = new Student("Jack", "Winchester", "gograf");
            Student sixth = new Student("Gogi", "Gogich", "spanish");

            classroom.RegisterStudent(first);
            classroom.RegisterStudent(second);
            classroom.RegisterStudent(third);
            classroom.RegisterStudent(forth);
            classroom.RegisterStudent(fifth);
            classroom.RegisterStudent(sixth);

            classroom.DismissStudent("Dean", "winchester");
            classroom.DismissStudent("Dean", "Winchester");
            classroom.DismissStudent("Dean", "Wincr");
            ...
            //classroom.GetSubjectInfo("Music");
        }
    }
}
